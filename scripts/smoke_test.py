...
def stage_7_summary() -> None:
    ...
    print()
    print(f"  {'Stage':<40} {'Status':<8} Detail")
    print(f"  {'─' * 40} {'─' * 8} {'─' * 40}")
    for r in STAGE_RESULTS:
        ...
        if len(detail) > 40:
            detail = detail[:37] + "..."
        print(f"  {r['stage']:<40} {status_display:<8} {detail}")

    print()
    print(f"  ══════════════════════════════════════════════════════")
    print(f"  TOTAL: {passed} of {total} stages passed end-to-end")
    print(f"  ══════════════════════════════════════════════════════")
    ...
    print()
    if failed == 0:
        print("  ✓ The system CAN produce narration from a spell cast end-to-end.")
    else:
        print(f"  ✗ The system CANNOT fully produce narration end-to-end "
              f"({failed} stage(s) failed).")
    print()
...
def main() -> int:
    print()
    print("╔══════════════════════════════════════════════════════════════════╗")
    print("║  WO-SMOKE-TEST-001: End-to-End Integration Demo                ║")
    print("║  Content Pack → Compile → Session → Fireball → Narration       ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
