...
**Last triaged:** 2026-03-01 (session 27+) — Batch AM ACCEPTED (CDS+CDU+FHS+CLF, 32/32 gates, commit 801875d). FINDING-ENGINE-FREE-HAND-SETTER-002 → CLOSED. FINDING-ENGINE-CONDITION-NORMALIZE-DEAD-CODE-001 → CLOSED (comment added in CLF WO). New LOW findings: FINDING-ENGINE-MAGIC-MISSILE-CL-SCALE-001 + FINDING-ENGINE-TWF-FREE-HANDS-001. Sweep counter: 4/5 after AM — AK+AL+AM+AN; sweep due after AO.
...
| FINDING-ENGINE-CL-SCALED-DAMAGE-MISSING-001 | No per-CL damage dice scaling in spell resolution — spells like fireball don't scale damage with CL | CL2 WO | **IN FLIGHT** — WO-ENGINE-CL-DAMAGE-SCALE-001 (Batch AM CDS, dispatched 2026-03-01). Expiry: Batch AN. |
| FINDING-ENGINE-CL-SCALED-DURATION-MISSING-001 | No per-CL duration scaling in spell resolution — buff/debuff durations don't scale with CL | CL2 WO | **IN FLIGHT** — WO-ENGINE-CL-DURATION-SCALE-001 (Batch AM CDU, dispatched 2026-03-01). Expiry: Batch AN. |
