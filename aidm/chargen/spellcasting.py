...
CLASS_SPELL_LISTS: Dict[str, Dict[int, List[str]]] = {
    "wizard": {
        ...
        5: ["cone_of_cold", "hold_monster", "wall_of_stone", "telekinesis",
            "baleful_polymorph"],
        6: ["chain_lightning", "disintegrate", "greater_dispel_magic", "true_seeing",
            "antimagic_field"],
        7: ["delayed_blast_fireball", "finger_of_death", "greater_teleport",
            "prismatic_spray", "reverse_gravity"],
        8: ["horrid_wilting", "polar_ray", "sunburst", "power_word_stun", "mind_blank"],
        9: ["wish", "meteor_swarm", "power_word_kill", "gate", "prismatic_sphere",
            "time_stop"],
    },
    "cleric": {
        0: ["detect_magic", "light", "read_magic", "resistance", "mending", "guidance"],
        ...
        5: ["raise_dead"],
        6: ["heal_spell", "blade_barrier", "greater_dispel_magic", "true_seeing"],
        7: ["regenerate", "resurrection"],
        8: ["greater_planar_ally", "mass_cure_critical_wounds"],
        9: ["miracle", "gate"],
    },
    "druid": {
        0: ["detect_magic", "light", "read_magic", "resistance", "mending", "guidance"],
        ...
        6: ["antimagic_field", "greater_dispel_magic"],
        7: ["true_seeing", "reverse_gravity"],
        8: ["sunburst", "finger_of_death"],
        9: [],
    },
    "sorcerer": {
        0: ["detect_magic", "light", "read_magic", "resistance", "mending", "guidance"],
